...
public class Spawner : MonoBehaviour
{
    ...
    public float maxSpawnTime= 3.0f; //Minimum amount of time between spawning objects
    ...
    void Update()
    {
        //Add Time.deltaTime returns the amount of time passes since the last frame.
        //This will create a float that counts up in seconds
        timeSinceLastSpawn = timeSinceLastSpawn + Time.deltaTime;

        //If we've counted past the of time we need to wait...
